<template>
  <section>
    ...
    <exp-item title="應徵" subtitle="ScrumMaster、程式設計師" :is-headlines="true" from="2019-01">
      <p>
        詳見<router-link to="/hunting">求職</router-link>。
      </p>
      <section>
        <h5>敏捷工作</h5>
        <p>
      ...
      <h6>偏好地點</h6>
      <p>
        若是需要緊密與團隊合作，工作地點偏好在台中。在純開發且偏個人的職缺上，偏好能夠遠端工作，並接受定期去公司開重要會議，其餘溝通則以文字溝通為主，語音溝通為輔。自認擅長釐清需求並寫成規格，且已經有數次接案與實際遠端工作的經驗，因此在遠端合作上有一定的信心。
      </p>
    </exp-item>
    ...
    <exp-item title="接案" from="2014-09">
      <p>
