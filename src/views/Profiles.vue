<template>
  <section>
    ...
    <article class="mt-5">
      ...
      <p>
        對於我過往的工作經歷，可以參見本站的<router-link to="/cv"><ruby>履歷<rt>CV</rt></ruby></router-link>頁面；也可以下載英文版的<a href="https://fntsr.page.link/resume-en" target="_blank"><ruby>簡歷<rt>résumé</rt></ruby></a>，或是選擇根據職缺類型去編寫的中文簡歷：<a href="https://fntsr.page.link/resume-sm" target="_blank">Scrum Master</a>、<a href="https://fntsr.page.link/resume-rd" target="_blank">程式設計師</a>；。若有興趣認識、合作，可以來信 work@fntsr.tw 聯絡。
      </p>
    </article>
  </section>
</template>
